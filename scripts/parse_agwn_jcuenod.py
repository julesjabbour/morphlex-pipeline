...
SQL format: INSERT INTO greek_synonyms VALUES (id,'lemma','pos','PWN_offset',...);
  - Column 1 (index 0): id
  - Column 2 (index 1): lemma (Greek word)
  - Column 3 (index 2): pos
  - Column 4 (index 3): PWN offset (8-digit number)

Output: data/open_wordnets/agwn_synset_map.pkl
Format: {oewn_synset_id: [greek_word1, greek_word2, ...], ...}
...
def main():
    log("=" * 70)
    log("PARSE AGWN (JCUENOD) - BUILD OEWN SYNSET MAP")
    log("=" * 70)
